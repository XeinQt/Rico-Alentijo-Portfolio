...
const PROJECTS = [
  ...
  },
  {
    ...
    featuredScreens: [1, 4],
    name: "Camillians HHS",
    subtitle: "Home Health Services Landing Page",
    emoji: "🏥",
    ...
    responsibilities: [
      ...
      "Implemented a hero section with a full-width background image and prominent 'Call Now' CTA",
      "Designed a services grid highlighting in-home care, skilled professionals, and quality assurance features",
      "Styled a responsive contact page with business contact details, inquiry forms, and location information",
      "Applied a branded color scheme of navy blue and red consistent with the Camillians identity",
      "Ensured cross-browser compatibility and clean semantic HTML structure throughout",
    ],
    ...
    galleryImages: [
      "img/CamilliansLandingPage/desktop-0.png",
      "img/CamilliansLandingPage/desktop-1.png",
      "img/CamilliansLandingPage/desktop-2.png",
      "img/CamilliansLandingPage/desktop-3.png",
      "img/CamilliansLandingPage/desktop-4.png",
      "img/CamilliansLandingPage/desktop-5.png",
      "img/CamilliansLandingPage/desktop-6.png",
      "img/CamilliansLandingPage/desktop-7.png",
    ],
  },
];
